...
class QemuController:
	...
	@staticmethod
	def create_qcow2_img(path: Path, size_mb: int) -> None:
		""" 
	...
	@staticmethod
	def setup_alpine_linux(qcow2_file: Path, alpine_iso: Path, virtualization: str):
		"""
		...
		QemuController._validate_setup_args(qcow2_file, alpine_iso, virtualization)
	...
	@staticmethod
	def _validate_setup_args(qcow2_file: Path, alpine_iso: Path, virtualization: str) -> None:
