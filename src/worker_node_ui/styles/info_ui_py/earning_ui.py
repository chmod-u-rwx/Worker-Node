...
################################################################################
## Form generated from reading UI file 'earning_info.ui'
##
...
class Ui_Earndash(object):
    def setupUi(self, earning_dash):
        if not earning_dash.objectName():
            earning_dash.setObjectName(u"earning_dash")
        earning_dash.resize(1440, 810)
        earning_dash.setMinimumSize(QSize(1440, 810))
        earning_dash.setMaximumSize(QSize(1440, 810))
        self.centralwidget = QWidget(earning_dash)
        self.centralwidget.setObjectName(u"centralwidget")
        self.centralwidget.setEnabled(True)
        self.centralwidget.setMinimumSize(QSize(1440, 810))
        self.centralwidget.setMaximumSize(QSize(1440, 810))
        self.centralwidget.setStyleSheet("background-image: url('src/worker_node_ui/resources/images/earn_bg.png');")
...
"\n"
"")
        self.earning_con = QLabel(self.centralwidget)
...
"")
        ...
        self.balance_con = QLabel(self.centralwidget)
...
"}\n"
"")
        self.balance_details = QLabel(self.centralwidget)
...
"\n"
"")
        self.eline_chart = QWidget(self.centralwidget)
...
"")
        ...
        self.toggle_switch.setGeometry(QRect(1150, 65, 91, 21))
...
"\n"
"")
        self.ppayouts_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.etoday_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.acc_number = QLabel(self.centralwidget)
...
"\n"
"")
        self.accnum_label = QLabel(self.centralwidget)
...
"}\n"
"")
        self.trans_con = QLabel(self.centralwidget)
...
"}\n"
"")
        self.revenue_con = QLabel(self.centralwidget)
...
"}\n"
"")
        self.tvp_con = QLabel(self.centralwidget)
...
"\n"
"")
        self.earning_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.avgearning_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.wavg_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.current_earning = QLabel(self.centralwidget)
...
"\n"
"")
        self.cearning_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.current_chart = QWidget(self.centralwidget)
...
"")
        self.transactions = QLabel(self.centralwidget)
...
"\n"
"")
        self.revenue = QLabel(self.centralwidget)
...
"\n"
"")
        self.totalv_performance = QLabel(self.centralwidget)
...
"\n"
"")
        self.tvp_chart = QWidget(self.centralwidget)
...
"")
        self.tjexe_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.tearning_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.ajsrate_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.revenue_chart = QWidget(self.centralwidget)
...
"")
        self.trevenue_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.yrevenue_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.rweek_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.rlweek_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.lrevenue_label = QLabel(self.centralwidget)
...
"\n"
"")
        self.trans_tablev = QTableView(self.centralwidget)
...
"}\n"
"")
        earning_dash.setCentralWidget(self.centralwidget)
        ...
        self.retranslateUi(earning_dash)

        QMetaObject.connectSlotsByName(earning_dash)
    # setupUi

    def retranslateUi(self, earning_dash):
        earning_dash.setWindowTitle(QCoreApplication.translate("earning_dash", u"CrowdCloud", None))
        self.logo.setText("")
        self.earning_rate.setText(QCoreApplication.translate("earning_dash", u"Earning Rate", None))
        ...
        self.balance_details.setText(QCoreApplication.translate("earning_dash", u"Balance Details", None))
        self.prof_button.setText("")
        self.notif_button.setText("")
        self.workerM_label.setText(QCoreApplication.translate("earning_dash", u"Worker Mode", None))
        self.ppayouts_label.setText(QCoreApplication.translate("earning_dash", u"Pending payouts: 650.25", None))
        self.etoday_label.setText(QCoreApplication.translate("earning_dash", u"Earning Today: 450.00", None))
        self.acc_number.setText(QCoreApplication.translate("earning_dash", u"Account Number", None))
        self.accnum_label.setText(QCoreApplication.translate("earning_dash", u"014815685355014815685355", None))
        self.current_con.setText("")
        self.trans_con.setText("")
        self.revenue_con.setText("")
        self.tvp_con.setText("")
        self.amount_label.setText(QCoreApplication.translate("earning_dash", u"PHP 30,000.25", None))
        self.inc_label.setText(QCoreApplication.translate("earning_dash", u"-- --", None))
        self.currentp_label.setText(QCoreApplication.translate("earning_dash", u"-- --", None))
        self.earning_label.setText(QCoreApplication.translate("earning_dash", u"PHP 125/hr", None))
        self.avgearning_label.setText(QCoreApplication.translate("earning_dash", u"Average Earning: 50/hr", None))
        self.wavg_label.setText(QCoreApplication.translate("earning_dash", u"Weekly Average: 110/hr", None))
        self.current_earning.setText(QCoreApplication.translate("earning_dash", u"Current Earnings", None))
        self.cearning_label.setText(QCoreApplication.translate("earning_dash", u"PHP 890.93", None))
        self.transactions.setText(QCoreApplication.translate("earning_dash", u"Transactions", None))
        self.revenue.setText(QCoreApplication.translate("earning_dash", u"Revenue", None))
        self.totalv_performance.setText(QCoreApplication.translate("earning_dash", u"Total View Performance", None))
        self.tjexe_label.setText(QCoreApplication.translate("earning_dash", u"Total Jobs Executed: 1234", None))
        self.tearning_label.setText(QCoreApplication.translate("earning_dash", u"Total Earnings: 512.456", None))
        self.ajsrate_label.setText(QCoreApplication.translate("earning_dash", u"Average Job Success Rate: 88%", None))
        self.trevenue_label.setText(QCoreApplication.translate("earning_dash", u"Today's revenue: 700.00", None))
        self.yrevenue_label.setText(QCoreApplication.translate("earning_dash", u"Yesterday's revenue: 675.24", None))
        self.rweek_label.setText(QCoreApplication.translate("earning_dash", u"Revenue this week: 1123.75", None))
        self.rlweek_label.setText(QCoreApplication.translate("earning_dash", u"Revenue last week: 7400.89", None))
        self.lrevenue_label.setText(QCoreApplication.translate("earning_dash", u"Lifetime revenue: 11,345.56", None))
    # retranslateUi
