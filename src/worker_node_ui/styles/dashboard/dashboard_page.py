...
class UiDashboardPage(object):
    def setupUi(self, dashboard_page):
        if not dashboard_page.objectName():
            dashboard_page.setObjectName(u"dashboard_page")
        dashboard_page.resize(1440, 810)
        dashboard_page.setMinimumSize(QSize(1440, 810))
        dashboard_page.setMaximumSize(QSize(1440, 810))
        self.bg_label = QLabel(dashboard_page)
        self.bg_label.setPixmap(QPixmap("src/worker_node_ui/resources/images/gen_dashboard.png"))
        self.bg_label.setScaledContents(True)
        self.bg_label.setGeometry(0, 0, dashboard_page.width(), dashboard_page.height())
        self.bg_label.lower()
        self.horizontalLayoutWidget = QWidget(dashboard_page)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(0, 0, 2, 2))
        self.horizontalLayout = QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.logo = QLabel(dashboard_page)
        ...
        self.welcome_label = QLabel(dashboard_page)
...
"\n"
"")
        self.cpu_usage = QLabel(dashboard_page)
...
"")
        self.usage_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.verticalLayoutWidget = QWidget(dashboard_page)
        ...
        self.settings_bt = QToolButton(dashboard_page)
...
"")
        ...
        self.rate_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.current_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.run_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.avg_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.exe_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.slots_con = QLabel(dashboard_page)
...
"}\n"
"")
        self.memory_usage = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.cache_usage = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.earning_rate = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.current_earnings = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.avg_job = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.jobs_executed = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.running_jobs = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.jobs_slots = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.rate_chart = QGraphicsView(dashboard_page)
        ...
        self.cpu_chart = QWidget(dashboard_page)
        self.cpu_chart.setObjectName(u"cpu_chart")
        self.cpu_chart.setGeometry(QRect(150, 210, 191, 191))
        self.cpu_chart.setStyleSheet(u"background: transparent;")
        self.mem_chart = QWidget(dashboard_page)
        self.mem_chart.setObjectName(u"mem_chart")
        self.mem_chart.setGeometry(QRect(440, 210, 191, 191))
        self.mem_chart.setStyleSheet(u"background: transparent;")
        self.cache_chart = QWidget(dashboard_page)
        ...
        self.rjobs_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.jslots_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.jexe_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.ajob_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.avgtp_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.exet_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.current_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.prof_button = QToolButton(dashboard_page)
...
"")
        ...
        self.notif_button = QToolButton(dashboard_page)
...
"")
        ...
        self.inc_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.inc_wid = QWidget(dashboard_page)
        ...
        self.currentp_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.rate_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.hist_con = QWidget(dashboard_page)
...
"")
        ...
        self.toggle_switch = QWidget(dashboard_page)
        ...
        self.workerM_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.widget_7 = QWidget(dashboard_page)
...
"background-color: #D6BDDC;")
        self.widget_8 = QWidget(dashboard_page)
...
"background: transparent;\n"
"")
        self.avail_space = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.memo_used = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.memo_total = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.vm_id = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.cpu_perce = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.diskusage_label = QLabel(dashboard_page)
...
"background: transparent;\n"
"")
        self.report_bt = QPushButton(dashboard_page)
...
"}\n"
"")
        self.report_bt2 = QToolButton(dashboard_page)
        ...
        icon8 = QIcon()
        icon8.addFile(u"src/worker_node_ui/resources/fbuttons/view-report.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.retranslateUi(dashboard_page)

        QMetaObject.connectSlotsByName(dashboard_page)
    # setupUi

    def retranslateUi(self, dashboard_page):
        dashboard_page.setWindowTitle(QCoreApplication.translate("dashboard_page", u"CrowdCloud", None))
        self.logo.setText("")
        self.welcome_label.setText(QCoreApplication.translate("dashboard_page", u"Hi,  Welcome Back", None))
        self.cpu_usage.setText(QCoreApplication.translate("dashboard_page", u"CPU Usage per VM", None))
        ...
        self.memory_usage.setText(QCoreApplication.translate("dashboard_page", u"Memory Usage per VM", None))
        self.cache_usage.setText(QCoreApplication.translate("dashboard_page", u"Cache Disk Usage", None))
        self.earning_rate.setText(QCoreApplication.translate("dashboard_page", u"Earning Rate", None))
        self.current_earnings.setText(QCoreApplication.translate("dashboard_page", u"Current Earnings", None))
        self.avg_job.setText(QCoreApplication.translate("dashboard_page", u"Average Job", None))
        self.jobs_executed.setText(QCoreApplication.translate("dashboard_page", u"Jobs Executed", None))
        self.running_jobs.setText(QCoreApplication.translate("dashboard_page", u"Running Jobs", None))
        self.jobs_slots.setText(QCoreApplication.translate("dashboard_page", u"Job Slots", None))
        self.rjobs_label.setText(QCoreApplication.translate("dashboard_page", u"12", None))
        self.jslots_label.setText(QCoreApplication.translate("dashboard_page", u"12", None))
        self.jexe_label.setText(QCoreApplication.translate("dashboard_page", u"544", None))
        self.ajob_label.setText(QCoreApplication.translate("dashboard_page", u"3/min", None))
        self.avgtp_label.setText(QCoreApplication.translate("dashboard_page", u"Avg Throughput: 2.5/min", None))
        self.exet_label.setText(QCoreApplication.translate("dashboard_page", u"Three Days", None))
        self.current_label.setText(QCoreApplication.translate("dashboard_page", u"PHP 890.93", None))
        self.prof_button.setText("")
        self.notif_button.setText("")
        self.inc_label.setText(QCoreApplication.translate("dashboard_page", u"-- --", None))
        self.currentp_label.setText(QCoreApplication.translate("dashboard_page", u"-- --", None))
        self.rate_label.setText(QCoreApplication.translate("dashboard_page", u"PHP 125/hr", None))
        ___qtablewidgetitem = self.hist_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("dashboard_page", u"User ID", None)); #type: ignore
        ___qtablewidgetitem1 = self.hist_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("dashboard_page", u"Retained", None)); #type: ignore
        ___qtablewidgetitem2 = self.hist_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("dashboard_page", u"Duration", None)); #type: ignore
        ___qtablewidgetitem3 = self.hist_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("dashboard_page", u"Amount", None)); #type: ignore
        self.job_history.setText(QCoreApplication.translate("dashboard_page", u"Job History", None))
        self.refresh_bt.setText("")
        self.workerM_label.setText(QCoreApplication.translate("dashboard_page", u"Worker Mode", None))
        self.consumed_data.setText(QCoreApplication.translate("dashboard_page", u"Consumed Data", None))
        self.avail_space.setText(QCoreApplication.translate("dashboard_page", u"Available Space", None))
        self.memo_used.setText(QCoreApplication.translate("dashboard_page", u"Used", None))
        self.memo_total.setText(QCoreApplication.translate("dashboard_page", u"Total", None))
        self.vm_id.setText(QCoreApplication.translate("dashboard_page", u"VM ID", None))
        self.cpu_perce.setText(QCoreApplication.translate("dashboard_page", u"CPU %", None))
        self.diskusage_label.setText(QCoreApplication.translate("dashboard_page", u"324/1000 MB", None))
        self.report_bt.setText(QCoreApplication.translate("dashboard_page", u"View Report", None))
