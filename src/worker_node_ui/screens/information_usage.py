...
from PySide6.QtWidgets import QWidget, QTableWidgetItem, QVBoxLayout, QSpacerItem, QSizePolicy, QHBoxLayout

from src.worker_node_ui.styles.information.ui_py.information_usage import UiInformationUsage
...
class UsageWindow(QWidget):
    ...
    def add_chart(self):
        ...
        cpu_ax.pie(cpu_data, startangle=90, colors=["#D6BDDC", "#49067C"], wedgeprops={'width': 0.3, 'edgecolor': 'white'})
        cpu_ax.axis('equal')
        ...
        mem_ax.pie(mem_data, startangle=90, colors=["#49067C", "#151A20"], wedgeprops={'width': 0.5, 'edgecolor': 'white'})
        mem_ax.axis('equal')
        ...
        cache_ax.barh(["Cache"], [100 - cache_used], color="#FFE5E8", height=0.6, left=cache_used, zorder=1)
    ...
    #dummy data
        ...
        for row, vm in enumerate(dummy_vms):
            ...
            for col in range(1, 6):
                table.item(row, col).setTextAlignment(Qt.AlignmentFlag.AlignCenter) #type:ignore
